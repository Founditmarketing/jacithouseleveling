  ...
  return (
    <>
      ...
      <section className="bg-jac-green text-white py-6 md:py-8 relative z-30 -mt-1 shadow-xl">
        <div className="max-w-[1400px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12 text-center md:text-left">
          <div className="flex-1">
            <h2 className="font-display font-bold text-2xl md:text-3xl lg:text-4xl leading-tight text-white uppercase tracking-tight mb-2">
              Spring Special – <span className="text-jac-lime drop-shadow-sm">10% Off Foundation Repairs!</span>
            </h2>
          ...
          <div className="shrink-0">
            <Link to="/contact" className="inline-flex items-stretch group relative overflow-hidden border border-white">
              <div className="absolute inset-0 bg-jac-lime w-0 group-hover:w-full transition-all duration-300 ease-out z-0"></div>
              <div className="bg-transparent group-hover:text-jac-charcoal text-white px-6 md:px-8 py-3 md:py-4 font-bold tracking-wide text-base md:text-lg flex items-center justify-center relative z-10 transition-colors duration-300 uppercase whitespace-nowrap">
                Book Now
              </div>
