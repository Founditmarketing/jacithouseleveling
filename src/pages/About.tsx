        ...
        <div className="max-w-[1400px] mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1">
            <h2 className="font-display font-black text-3xl md:text-5xl uppercase text-jac-charcoal mb-8">
              Decades of <span className="text-jac-green">Dependable</span> Solutions
            </h2>
            
            <div className="space-y-6 text-gray-600 leading-relaxed text-lg">
              <p>
                With over 25 years of hands-on experience, <BrandName /> House Leveling & Foundation Repair LLC delivers fast, reliable, and long-lasting foundation solutions across East Texas. From pier and beam repair to slab lifting, drainage solutions, and foam injection, we handle every project with precision and care—ensuring your home stays safe, stable, and structurally sound.
              </p>
              <p>
                We combine proven methods with state-of-the-art equipment to deliver results that exceed expectations. Our team is committed to quality, integrity, and customer satisfaction, giving every homeowner peace of mind.
              </p>
              <p className="font-bold text-jac-charcoal text-xl pt-2 border-t border-gray-100">
                No shortcuts. No compromises. Just dependable service that stands the test of time.
              </p>
            </div>
          ...
          <div className="order-1 lg:order-2 relative aspect-[4/3] md:aspect-square lg:aspect-[4/5] overflow-hidden rounded-sm shadow-2xl group">
            <img 
              ...
              alt="Jac-It House Leveling Experience" 
