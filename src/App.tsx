          ...
          <div className="relative mt-12">
            ...
            <div className="grid md:grid-cols-3 gap-8 relative z-10">
              ...
              <div className="flex flex-col items-center text-center group bg-white border border-jac-green/30 p-8 pt-10 shadow-sm hover:shadow-2xl transition-all duration-500 relative overflow-hidden rounded-sm hover:-translate-y-2">
                ...
                <div className="absolute top-2 left-2 w-8 h-8 border-t-4 border-l-4 border-transparent group-hover:border-jac-green transition-all duration-500 group-hover:top-4 group-hover:left-4"></div>
                <div className="absolute bottom-2 right-2 w-8 h-8 border-b-4 border-r-4 border-transparent group-hover:border-jac-green transition-all duration-500 group-hover:bottom-4 group-hover:right-4"></div>
                {/* Background Hover Effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-jac-green/0 to-jac-lime/0 group-hover:from-jac-green/5 group-hover:to-jac-lime/5 transition-all duration-500 z-0"></div>
                
                {/* Watermark Number */}
                <div className="absolute top-2 right-4 text-7xl font-display font-black text-gray-100 group-hover:text-jac-lime/20 transition-colors duration-500 select-none z-0">
                  01
                </div>
                <h4 className="font-subdisplay font-bold text-2xl uppercase mb-4 mt-6 text-jac-charcoal tracking-wide relative z-10 group-hover:text-jac-green transition-colors duration-300">No Cut Corners</h4>
              ...
              <div className="flex flex-col items-center text-center group bg-white border border-jac-green/30 p-8 pt-10 shadow-sm hover:shadow-2xl transition-all duration-500 relative overflow-hidden rounded-sm hover:-translate-y-2">
                ...
                <h4 className="font-subdisplay font-bold text-2xl uppercase mb-4 mt-6 text-jac-charcoal tracking-wide relative z-10 group-hover:text-jac-green transition-colors duration-300">Heavy-Duty Materials</h4>
              ...
              <div className="flex flex-col items-center text-center group bg-white border border-jac-green/30 p-8 pt-10 shadow-sm hover:shadow-2xl transition-all duration-500 relative overflow-hidden rounded-sm hover:-translate-y-2">
                ...
                <h4 className="font-subdisplay font-bold text-2xl uppercase mb-4 mt-6 text-jac-charcoal tracking-wide relative z-10 group-hover:text-jac-green transition-colors duration-300">Owner On-Site</h4>
